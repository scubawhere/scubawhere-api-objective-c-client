...
@interface SWGAddonApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGAddonApi

NSString* kSWGAddonApiErrorDomain = @"SWGAddonApiErrorDomain";
NSInteger kSWGAddonApiMissingParamErrorCode = 234513;
...
-(NSNumber*) addAddonWithName: (NSString*) name
    ...
    if (name == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGAddonApiErrorDomain code:kSWGAddonApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/addon/add"];
...
-(NSNumber*) deleteAddonWithBody: (NSNumber*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/addon/delete"];
...
-(NSNumber*) getAddonWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/addon"];
...
/// Retrieve all addons
/// 
///  @returns NSArray<SWGAddon>*
///
-(NSNumber*) getAllAddonsWithCompletionHandler: 
    (void (^)(NSArray<SWGAddon>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/addon/all"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGAddon>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGAddon>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getAllWithTrashedAddonsWithCompletionHandler: 
    (void (^)(NSArray<SWGAddon>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/addon/all-with-trashed"];
...
-(NSNumber*) updateAddonWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/addon/edit"];
