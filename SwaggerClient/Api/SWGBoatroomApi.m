...
@interface SWGBoatroomApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGBoatroomApi

NSString* kSWGBoatroomApiErrorDomain = @"SWGBoatroomApiErrorDomain";
NSInteger kSWGBoatroomApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGBoatroomApi *sharedAPI;
...
-(NSNumber*) createBoatroomWithName: (NSString*) name
    ...
    if (name == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGBoatroomApiErrorDomain code:kSWGBoatroomApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boatroom/add"];
...
-(NSNumber*) deleteBoatroomWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boatroom/delete"];
...
-(NSNumber*) editBoatroomWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boatroom/edit"];
...
/// 
///  @returns NSArray<SWGBoatroom>*
///
-(NSNumber*) getAllBoatroomsWithCompletionHandler: 
    (void (^)(NSArray<SWGBoatroom>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boatroom/all"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGBoatroom>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGBoatroom>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getAllWithTrashedBoatroomsWithCompletionHandler: 
    (void (^)(NSArray<SWGBoatroom>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boatroom/all-with-trashed"];
...
-(NSNumber*) getBoatroomWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boatroom"];
