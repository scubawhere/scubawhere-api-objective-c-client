...
@interface SWGBoatApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGBoatApi

NSString* kSWGBoatApiErrorDomain = @"SWGBoatApiErrorDomain";
NSInteger kSWGBoatApiMissingParamErrorCode = 234513;
...
-(NSNumber*) createBoatWithName: (NSString*) name
    ...
    if (name == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGBoatApiErrorDomain code:kSWGBoatApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boat/add"];
...
-(NSNumber*) deleteBoatWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boat/delete"];
...
-(NSNumber*) editBoatWithName: (NSString*) name
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boat/edit"];
...
/// Retrieve all boats
/// 
///  @returns NSArray<SWGBoat>*
///
-(NSNumber*) getAllBoatsWithCompletionHandler: 
    (void (^)(NSArray<SWGBoat>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boat/all"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGBoat>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGBoat>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getAllWithTrashedBoatsWithCompletionHandler: 
    (void (^)(NSArray<SWGBoat>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boat/all-with-trashed"];
...
-(NSNumber*) getBoatWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/boat"];
