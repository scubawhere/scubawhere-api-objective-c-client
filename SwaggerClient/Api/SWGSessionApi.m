...
@interface SWGSessionApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGSessionApi

NSString* kSWGSessionApiErrorDomain = @"SWGSessionApiErrorDomain";
NSInteger kSWGSessionApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGSessionApi *sharedAPI;
...
///
///  @returns SWGInlineResponse20043*
///
-(NSNumber*) createSessionWithStart: (NSDate*) start
    ...
    if (start == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGSessionApiErrorDomain code:kSWGSessionApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/add"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGInlineResponse20043*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGInlineResponse20043*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deleteSessionWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/delete"];
...
///  @param boatId  (optional)
///
///  @returns SWGInlineResponse20044*
///
-(NSNumber*) editSessionWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/edit"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGInlineResponse20044*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGInlineResponse20044*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGInlineResponse20045*
///
-(NSNumber*) filterSessionsWithAfter: (NSDate*) after
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/filter"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGInlineResponse20045*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGInlineResponse20045*)data, error);
                                }
                           }
          ];
}
...
/// 
///  @returns NSArray<SWGSession>*
///
-(NSNumber*) getAllSessionsWithCompletionHandler: 
    (void (^)(NSArray<SWGSession>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/all"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGSession>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGSession>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getAllWithTrashedSessionsWithCompletionHandler: 
    (void (^)(NSArray<SWGSession>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/all-with-trashed"];
...
-(NSNumber*) getManifestWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/manifest"];
...
-(NSNumber*) getSessionWithId: (NSNumber*) _id
    completionHandler: (void (^)(SWGInlineResponse20043* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session"];
...
-(NSNumber*) getTodaySessionsWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/today"];
...
-(NSNumber*) getTommorowSessionsWithCompletionHandler: 
    (void (^)(SWGInlineResponse20045* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/session/tommorow"];
