...
@interface SWGClassApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGClassApi

NSString* kSWGClassApiErrorDomain = @"SWGClassApiErrorDomain";
NSInteger kSWGClassApiMissingParamErrorCode = 234513;
...
-(NSNumber*) classGetWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGClassApiErrorDomain code:kSWGClassApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/class"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGTraining*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGTraining*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) createClassWithName: (NSString*) name
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/class/add"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                           ...
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGInlineResponse20021*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deleteClassWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/class/delete"];
...
-(NSNumber*) editClassWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/class/edit"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                           ...
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGInlineResponse20022*)data, error);
                                }
                           }
          ];
}
...
/// 
///  @returns NSArray<SWGTraining>*
///
-(NSNumber*) getAllClassWithCompletionHandler: 
    (void (^)(NSArray<SWGTraining>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/class/all"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGTraining>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGTraining>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getAllWithTrashedClassWithCompletionHandler: 
    (void (^)(NSArray<SWGTraining>* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/class/all-with-trashed"];
